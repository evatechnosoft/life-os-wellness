# Handoff: menüde tatlı/tabak · set kartında rampa setleri · 21 Eyl setleri kayıtta

> 2026-09-24 18:51 · `dev` @ `787b9b8` · tag `v0.35.0` · plan: `docs/PLAN-GERCEKCI.md`
...
## Next (tek adım)
25 Eyl A′ sonrası: `GET /api/workouts?start=2026-09-25&end=2026-09-25` → `sets` dolu ve R satırı yok mu (sets_total = çalışma setleri).
