# Handoff: 0.31.0 (SW kendini siler) yayında · koç değerlendirmesi · tansiyon kararı Pazartesi

> 2026-09-23 18:50 · `dev` @ `3cf982f` (tag `v0.31.0` push edildi) · kod ağacı temiz
...
- Kalori: günlük hedef yok (kilit); sohbette haftalık ortalama bandı verildi: harcama ~2.780/gün (Mifflin tahmini),
  0.6 kg/hafta için ~700 açık → yemek haftalık ort. ~2.000–2.200. Pazar 7-gün ort 107.3 altına inmezse
